...
// node_modules/ngx-ui-loader/fesm2022/ngx-ui-loader.mjs
...
var _NgxUiLoaderService = class _NgxUiLoaderService {
  /**
   * Constructor
   */
  constructor(config) {
...
_NgxUiLoaderService.ɵfac = function NgxUiLoaderService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxUiLoaderService)(ɵɵinject(NGX_UI_LOADER_CONFIG_TOKEN, 8));
};
_NgxUiLoaderService.ɵprov = ɵɵdefineInjectable({
  token: _NgxUiLoaderService,
  factory: _NgxUiLoaderService.ɵfac,
  providedIn: "root"
});
var NgxUiLoaderService = _NgxUiLoaderService;
(() => {
...
var _NgxUiLoaderComponent = class _NgxUiLoaderComponent {
  /**
   * Constructor
   */
...
_NgxUiLoaderComponent.ɵfac = function NgxUiLoaderComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxUiLoaderComponent)(ɵɵdirectiveInject(DomSanitizer), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(NgxUiLoaderService));
};
_NgxUiLoaderComponent.ɵcmp = ɵɵdefineComponent({
  type: _NgxUiLoaderComponent,
...
var NgxUiLoaderComponent = _NgxUiLoaderComponent;
(() => {
...
var _NgxUiLoaderBlurredDirective = class _NgxUiLoaderBlurredDirective {
...
_NgxUiLoaderBlurredDirective.ɵfac = function NgxUiLoaderBlurredDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxUiLoaderBlurredDirective)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NgxUiLoaderService));
};
_NgxUiLoaderBlurredDirective.ɵdir = ɵɵdefineDirective({
  type: _NgxUiLoaderBlurredDirective,
...
var NgxUiLoaderBlurredDirective = _NgxUiLoaderBlurredDirective;
(() => {
...
var _NgxUiLoaderModule = class _NgxUiLoaderModule {
  /**
   * forRoot
   *
...
_NgxUiLoaderModule.ɵfac = function NgxUiLoaderModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxUiLoaderModule)();
};
_NgxUiLoaderModule.ɵmod = ɵɵdefineNgModule({
  type: _NgxUiLoaderModule,
...
_NgxUiLoaderModule.ɵinj = ɵɵdefineInjector({
  imports: [CommonModule]
});
var NgxUiLoaderModule = _NgxUiLoaderModule;
(() => {
...
var _NgxUiLoaderRouterModule = class _NgxUiLoaderRouterModule {
  /**
   * Constructor
   */
...
_NgxUiLoaderRouterModule.ɵfac = function NgxUiLoaderRouterModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxUiLoaderRouterModule)(ɵɵinject(_NgxUiLoaderRouterModule, 12), ɵɵinject(NGX_UI_LOADER_ROUTER_CONFIG_TOKEN, 8), ɵɵinject(Router), ɵɵinject(NgxUiLoaderService));
};
_NgxUiLoaderRouterModule.ɵmod = ɵɵdefineNgModule({
  type: _NgxUiLoaderRouterModule
});
_NgxUiLoaderRouterModule.ɵinj = ɵɵdefineInjector({});
var NgxUiLoaderRouterModule = _NgxUiLoaderRouterModule;
(() => {
...
var _NgxUiLoaderHttpInterceptor = class _NgxUiLoaderHttpInterceptor {
  /**
   * Constructor
   */
...
_NgxUiLoaderHttpInterceptor.ɵfac = function NgxUiLoaderHttpInterceptor_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxUiLoaderHttpInterceptor)(ɵɵinject(NGX_UI_LOADER_HTTP_CONFIG_TOKEN, 8), ɵɵinject(NgxUiLoaderService));
};
_NgxUiLoaderHttpInterceptor.ɵprov = ɵɵdefineInjectable({
  token: _NgxUiLoaderHttpInterceptor,
  factory: _NgxUiLoaderHttpInterceptor.ɵfac
});
var NgxUiLoaderHttpInterceptor = _NgxUiLoaderHttpInterceptor;
(() => {
...
var _NgxUiLoaderHttpModule = class _NgxUiLoaderHttpModule {
  /**
   * Constructor
   */
...
_NgxUiLoaderHttpModule.ɵfac = function NgxUiLoaderHttpModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxUiLoaderHttpModule)(ɵɵinject(_NgxUiLoaderHttpModule, 12));
};
_NgxUiLoaderHttpModule.ɵmod = ɵɵdefineNgModule({
  type: _NgxUiLoaderHttpModule
});
_NgxUiLoaderHttpModule.ɵinj = ɵɵdefineInjector({
  providers: [{
...
var NgxUiLoaderHttpModule = _NgxUiLoaderHttpModule;
(() => {
