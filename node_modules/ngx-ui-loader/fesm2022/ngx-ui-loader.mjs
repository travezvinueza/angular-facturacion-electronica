...
import { InjectionToken, Optional, Inject, Injectable, Input, ChangeDetectionStrategy, Component, Directive, NgModule, SkipSelf } from '@angular/core';
...
class NgxUiLoaderBlurredDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderBlurredDirective, deps: [{ token: i0.ElementRef }, { token: i0.Renderer2 }, { token: NgxUiLoaderService }], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "19.2.14", type: NgxUiLoaderBlurredDirective, isStandalone: false, selector: "[ngxUiLoaderBlurred]", inputs: { blur: "blur", loaderId: "loaderId" }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderBlurredDirective, decorators: [{
            type: Directive,
            args: [{
                    selector: '[ngxUiLoaderBlurred]',
                    standalone: false,
                }]
        }], ctorParameters: () => [{ type: i0.ElementRef }, { type: i0.Renderer2 }, { type: NgxUiLoaderService }], propDecorators: { blur: [{
                type: Input
            }], loaderId: [{
                type: Input
            }] } });
...
class NgxUiLoaderModule {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderModule, declarations: [NgxUiLoaderComponent, NgxUiLoaderBlurredDirective], imports: [CommonModule], exports: [NgxUiLoaderComponent, NgxUiLoaderBlurredDirective] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderModule, imports: [CommonModule] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderModule, decorators: [{
            type: NgModule,
            args: [{
...
class NgxUiLoaderRouterModule {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderRouterModule, deps: [{ token: NgxUiLoaderRouterModule, optional: true, skipSelf: true }, { token: NGX_UI_LOADER_ROUTER_CONFIG_TOKEN, optional: true }, { token: i1$1.Router }, { token: NgxUiLoaderService }], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderRouterModule }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderRouterModule }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderRouterModule, decorators: [{
            type: NgModule,
            args: [{}]
        }], ctorParameters: () => [{ type: NgxUiLoaderRouterModule, decorators: [{
                    type: Optional
                }, {
                    type: SkipSelf
...
class NgxUiLoaderHttpInterceptor {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderHttpInterceptor, deps: [{ token: NGX_UI_LOADER_HTTP_CONFIG_TOKEN, optional: true }, { token: NgxUiLoaderService }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderHttpInterceptor }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderHttpInterceptor, decorators: [{
            type: Injectable
        }], ctorParameters: () => [{ type: undefined, decorators: [{
                    type: Optional
                }, {
...
class NgxUiLoaderHttpModule {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderHttpModule, deps: [{ token: NgxUiLoaderHttpModule, optional: true, skipSelf: true }], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderHttpModule }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderHttpModule, providers: [
            {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: NgxUiLoaderHttpModule, decorators: [{
            type: NgModule,
            args: [{
                    providers: [
                        {
        ...
        }], ctorParameters: () => [{ type: NgxUiLoaderHttpModule, decorators: [{
                    type: Optional
                }, {
                    type: SkipSelf
                }] }] });
